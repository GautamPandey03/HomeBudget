...
const AddBudget=(props)=>{
    ...
    return(
      <View>
        ...
        placeholder='Enter Your Actual amount ' value={actualAmount}>
        </TextInput>
        
        <Text style={styles.main}> Planned amount of the item:</Text>
        <TextInput style={styles.input} 
        placeholder='Enter Your Planned Amount' value={plannedAmount} onChangeText={(text)=>setplannedAmount(text)}>
        </TextInput>
        <TouchableHighlight>
            <Text style={[styles.button,styles.primary]} onPress={SaveList}>Save</Text>
        </TouchableHighlight>
        <TouchableHighlight>
            <Text style={[styles.button,styles.success]} onPress={()=>props.navigation.navigate('Budget')}>View Budget List</Text>
        </TouchableHighlight>
      </View>
     );
   };
